    ...
    return (
        <div className="w-full min-h-screen bg-[#02040a] text-white font-sans overflow-hidden">
            ...
            >
                ...
                <div className="absolute top-20 right-20 w-[600px] h-[600px] bg-violet-600/10 rounded-full blur-[120px] -z-10" />
                <div className="absolute bottom-20 left-20 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[100px] -z-10" />
                ...
                <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-violet-500/10 border border-violet-500/20 rounded-full text-violet-400 mb-6 backdrop-blur-sm">
                            <Brain className="w-4 h-4" />
                            <span className="text-sm font-semibold">Next-Gen Intelligence</span>
                        </div>
                        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                            Artificial <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">Intelligence</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link href="/contact">
                                <button className="px-8 py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 rounded-xl font-bold hover:shadow-[0_0_20px_rgba(139,92,246,0.5)] transition-shadow">
                        ...
                        <div className="relative w-full h-full flex items-center justify-center">
                            ...
                            <div className="absolute z-20">
                                <motion.div
                                    ...
                                    className="w-32 h-32 bg-[#0e1a2b] border-2 border-violet-500 rounded-2xl flex items-center justify-center"
                                >
                            ...
                            {/* Connected Nodes */}
                            {[
                                { x: -150, y: -100, icon: Eye, color: 'text-blue-400' },
                                { x: 150, y: -100, icon: MessageSquare, color: 'text-cyan-400' },
                                { x: -150, y: 100, icon: Cpu, color: 'text-pink-400' },
                                { x: 150, y: 100, icon: Network, color: 'text-emerald-400' },
                                { x: 0, y: -180, icon: Sparkles, color: 'text-yellow-400' },
                            ].map((item, idx) => (
                                <motion.div
                                    key={idx}
                                    className="absolute w-16 h-16 bg-[#0e1a2b] border border-white/10 rounded-full flex items-center justify-center z-20"
            ...
            <section className="py-24 container mx-auto px-4">
                <div className="grid md:grid-cols-3 gap-8">
                    <motion.div
                        className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-violet-500/50 transition-colors"
                        whileHover={{ y: -5 }}
                    >
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold mb-4">NLP & LLMs</h3>
                        <p className="text-slate-400 leading-relaxed">
            ...
            <section className="py-24 bg-[#0e1a2b]">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl md:text-5xl font-bold mb-16 text-center">How We Integrate AI</h2>
                    <div className="grid md:grid-cols-4 gap-8">
                        {[
                            ...
                            <motion.div
                                ...
                                className="relative p-6 border-t font-mono"
                            >
                                <div className="text-4xl font-bold text-violet-500/20 mb-4">{item.step}</div>
            ...
            <section className="py-24 text-center container mx-auto px-4">
                <h2 className="text-4xl md:text-6xl font-bold mb-8">AI-First Future</h2>
