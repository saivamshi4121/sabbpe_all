    ...
    return (
        <div className="w-full min-h-screen bg-[#02040a] text-white font-sans overflow-hidden">
            ...
            >
                ...
                <div className="absolute top-20 right-1/4 w-[600px] h-[600px] bg-orange-600/10 rounded-full blur-[120px] -z-10" />
                <div className="absolute bottom-20 left-1/4 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[100px] -z-10" />
                ...
                <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/10 border border-orange-500/20 rounded-full text-orange-400 mb-6 backdrop-blur-sm">
                            <Bot className="w-4 h-4" />
                            <span className="text-sm font-semibold">24/7 Intelligent Support</span>
                        </div>
                        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                            Chatbots & <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-200">AI Agents</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link href="/contact">
                                <button className="px-8 py-4 bg-gradient-to-r from-orange-600 to-amber-600 rounded-xl font-bold hover:shadow-[0_0_20px_rgba(234,88,12,0.5)] transition-shadow">
                                    Automate Support
                                </button>
                            </Link>
                        </div>
                    ...
                    >
                        ...
                        <div className="w-full max-w-md bg-[#0e1a2b] border border-white/10 rounded-2xl shadow-2xl overflow-hidden relative">
                            {/* Header */}
                            <div className="bg-[#1f2937] p-4 flex items-center gap-3 border-b border-white/5">
            ...
            <section className="py-24 container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">Why Deploy AI Agents?</h2>
                    <p className="text-slate-400 text-lg">Enhance customer satisfaction while reducing operational costs.</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    >
                        <Headphones className="w-12 h-12 text-orange-400 mb-6" />
                    ...
                    <motion.div
                        ...
                        whileHover={{ y: -5, borderColor: 'rgba(249,115,22,0.5)' }}
                    >
                        <Smile className="w-12 h-12 text-amber-400 mb-6" />
                    ...
                    <motion.div
                        ...
                        whileHover={{ y: -5, borderColor: 'rgba(249,115,22,0.5)' }}
                    >
                        <Bot className="w-12 h-12 text-red-400 mb-6" />
                        <h3 className="text-2xl font-bold mb-4">Omnichannel</h3>
                        <p className="text-slate-400 leading-relaxed">
            ...
            {/* Integration Banner */}
            <section className="py-20 bg-gradient-to-r from-orange-900/20 to-amber-900/20 border-y border-white/5">
                <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div>
                        <h2 className="text-3xl font-bold mb-2">Seamless CRM Integration</h2>
                        <p className="text-slate-400">Connects with Salesforce, HubSpot, Zendesk, and more.</p>
                    </div>
                    <div className="flex gap-4">
                        {/* Logos could go here, simplified with circles */}
                        {[1, 2, 3, 4].map(i => (
                            <div key={i} className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center font-bold text-xs text-slate-500">API</div>
                        ))}
