    ...
    return (
        <div className="w-full min-h-screen bg-background text-foreground font-sans overflow-hidden">
            ...
            >
                ...
                <div className="absolute top-20 left-1/4 w-[600px] h-[600px] bg-fuchsia-100/50 rounded-full blur-[120px] -z-10" />
                <div className="absolute bottom-20 right-1/4 w-[500px] h-[500px] bg-violet-100/50 rounded-full blur-[100px] -z-10" />
                ...
                <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-fuchsia-50 border border-fuchsia-200 rounded-full text-fuchsia-700 mb-6 backdrop-blur-sm">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight text-slate-900">
                            Metaverse & <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-violet-500">AR/VR</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link href="/contact">
                                <button className="px-8 py-4 bg-gradient-to-r from-fuchsia-600 to-violet-600 rounded-xl font-bold text-white hover:shadow-[0_0_20px_rgba(192,38,211,0.5)] transition-shadow">
                                    Enter the Metaverse
                                </button>
                            </Link>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative w-64 h-64 preserve-3d">
                            ...
                            <motion.div
                                className="absolute inset-0 w-full h-full border border-fuchsia-200 bg-fuchsia-50/80 backdrop-blur-sm rounded-3xl"
                                animate={{
                                    rotateX: [0, 360],
                                    rotateY: [0, 360],
                                    scale: [1, 1.1, 1]
                            ...
                            >
                                <div className="absolute inset-4 border border-violet-200 rounded-2xl" />
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <Box className="w-24 h-24 text-fuchsia-600 opacity-50" />
                                </div>
                            </motion.div>
                            ...
                            {[
                                ...
                                <motion.div
                                    key={idx}
                                    className="absolute top-1/2 left-1/2 w-16 h-16 bg-white border border-violet-200 rounded-xl flex items-center justify-center shadow-lg"
                                ...
                                >
                                    <item.icon className="w-8 h-8 text-fuchsia-600" />
                                </motion.div>
                            ))}
                        </div>
                    </motion.div>
            ...
            <section className="py-24 container mx-auto px-4">
                <div className="grid md:grid-cols-3 gap-8">
                    <motion.div
                        ...
                        whileHover={{ y: -5 }}
                    >
                        <Glasses className="w-12 h-12 text-fuchsia-500 mb-6" />
                        <h3 className="text-2xl font-bold mb-4 text-slate-900">Virtual Reality (VR)</h3>
                    ...
                    <motion.div
                        ...
                        whileHover={{ y: -5 }}
                    >
                        <Maximize2 className="w-12 h-12 text-violet-500 mb-6" />
                        <h3 className="text-2xl font-bold mb-4 text-slate-900">Augmented Reality (AR)</h3>
                        <p className="text-slate-600 leading-relaxed">
                    ...
                    <motion.div
                        ...
                        whileHover={{ y: -5 }}
                    >
                        <Globe className="w-12 h-12 text-pink-500 mb-6" />
                        <h3 className="text-2xl font-bold mb-4 text-slate-900">Metaverse Spaces</h3>
                        <p className="text-slate-600 leading-relaxed">
            ...
            <section className="py-24 bg-slate-50">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl md:text-5xl font-bold mb-16 text-center text-slate-900">Immersive Solutions</h2>
                    <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <div className="h-full min-h-[400px] bg-white rounded-3xl overflow-hidden relative border border-slate-200 shadow-sm flex items-center justify-center">
                            <div className="absolute inset-0 bg-grid-black/[0.05]" />
                            <div className="text-center z-10">
                                <div className="text-6xl mb-4">🕶️</div>
                                <h3 className="text-2xl font-bold text-slate-900 mb-2">Try The Demo</h3>
                                <p className="text-slate-600 text-sm">Launch AR Experience</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 text-center container mx-auto px-4">
                <h2 className="text-4xl md:text-6xl font-bold mb-8 text-slate-900">Ready to Immerse?</h2>
                <Link href="/contact">
