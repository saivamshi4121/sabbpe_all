    ...
    return (
        <div className="w-full min-h-screen bg-background text-foreground font-sans overflow-hidden">
            ...
            >
                ...
                <div className="absolute top-20 right-20 w-[600px] h-[600px] bg-sky-100/50 rounded-full blur-[120px] -z-10" />
                ...
                <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-sky-50 border border-sky-200 rounded-full text-sky-700 mb-6 backdrop-blur-sm">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight text-slate-900">
                            Cloud <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-cyan-500">Computing</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link href="/contact">
                                <button className="px-8 py-4 bg-gradient-to-r from-sky-600 to-cyan-600 rounded-xl font-bold text-white hover:shadow-[0_0_20px_rgba(14,165,233,0.5)] transition-shadow">
                                    Migrate to Cloud
                                </button>
                            </Link>
                        </div>
                    ...
                    >
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            {/* Central Cloud Node */}
                            <motion.div
                                className="w-40 h-40 bg-white rounded-full border border-sky-200 shadow-lg flex items-center justify-center z-20"
                                animate={{ y: [-10, 10, -10] }}
                            ...
                            {[
                                ...
                                >
                                    <motion.div
                                        className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 bg-white border border-sky-200 rounded-xl flex items-center justify-center shadow-lg hover:border-cyan-400 transition-colors z-20"
                            ...
                            {/* Pulse Waves */}
                            <motion.div
                                className="absolute w-[400px] h-[400px] border border-sky-200 rounded-full z-0"
            ...
            <section className="py-24 container mx-auto px-4">
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    >
                        <LayoutGrid className="w-12 h-12 text-sky-500 mb-6" />
                        <h3 className="text-2xl font-bold mb-4 text-slate-900">Scalability</h3>
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold mb-4 text-slate-900">Global Reach</h3>
                        <p className="text-slate-600 leading-relaxed">
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold mb-4 text-slate-900">Cost Efficiency</h3>
                        <p className="text-slate-600 leading-relaxed">
            ...
            <section className="py-24 bg-slate-50">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl md:text-5xl font-bold mb-16 text-center text-slate-900">Cloud Services</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <motion.div
                                key={idx}
                                className="p-6 bg-white rounded-xl border border-slate-200 border-l-4 border-l-sky-500 hover:bg-sky-50 hover:shadow-md transition-all shadow-sm"
            ...
            {/* Partners/Platforms */}
            <section className="py-20 border-t border-slate-200 text-center">
                ...
                <div className="flex justify-center gap-12 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all">
                    <div className="text-2xl font-bold text-slate-800">AWS</div>
                    <div className="text-2xl font-bold text-slate-800">Azure</div>
                    <div className="text-2xl font-bold text-slate-800">Google Cloud</div>
                </div>
            </section>

            {/* CTA */}
            <section className="py-24 text-center container mx-auto px-4">
                <h2 className="text-4xl md:text-6xl font-bold mb-8 text-slate-900">Go Cloud Native</h2>
                <Link href="/contact">
