        ...
        <div className="w-full h-full flex flex-col items-center justify-center">
            ...
            <div className="w-full relative">
                ...
                <motion.div
                    ...
                    className="absolute left-1/2 -translate-x-1/2 w-1 h-full bg-gradient-to-b from-cyan-400 to-purple-400 origin-top"
                    ...
                    {milestones.map((milestone, i) => (
                        ...
                        >
                            ...
                            <div className={`flex-1 ${i % 2 === 0 ? 'text-right' : 'text-left'}`}>
                                <motion.div
                                    className="p-6 rounded-2xl border border-slate-200 bg-white shadow-md hover:shadow-lg transition-all"
                                    whileHover={{ scale: 1.05 }}
                                >
                                    <span className="text-cyan-600 font-bold text-lg">{milestone.year}</span>
                                    <h3 className="text-xl font-bold text-slate-900 mt-2">{milestone.title}</h3>
                                    <p className="text-slate-600 text-sm mt-2">{milestone.desc}</p>
                                </motion.div>
                            </div>
                            ...
                            <motion.div
                                ...
                                className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-br from-cyan-400 to-purple-400 flex items-center justify-center border-4 border-white shadow-lg shadow-cyan-200"
                            >
            ...
            <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="w-full mt-20 p-12 rounded-3xl border border-cyan-200 bg-gradient-to-r from-cyan-50 to-purple-50 relative overflow-hidden"
            >
                <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-100 rounded-full blur-[100px] -z-10" />
