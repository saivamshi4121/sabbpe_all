...
const navItems = [
    { label: 'Payment Gateway', id: 'gateway' },
    { label: 'Payment Links', id: 'links' },
    { label: 'Payment Forms', id: 'forms' },
    { label: 'Subscriptions', id: 'subscriptions' },
    { label: 'Payouts', id: 'payouts' },
    { label: 'Integration', id: 'integration' },
];

export default function AssistedNavigation() {
                    ...
                    >
                        {activeSection === item.id && (
                            <motion.div
                                ...
                                className="absolute inset-0 bg-sabbpe-blue/80 rounded-full -z-10"
