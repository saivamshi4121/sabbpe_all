                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8 text-center lg:text-left">
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-50 border border-slate-200 backdrop-blur-md"
                        >
                        ...
                        >
                            Command Center <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-blue-500 to-purple-600">
                                for Your Money
                            </span>
                        </motion.h1>
                        ...
                        >
                            <button className="flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-bold text-white bg-blue-600 hover:bg-blue-700 transition-all hover:scale-105 shadow-lg shadow-blue-200">
                                Explore Dashboard
                                <ArrowRight className="w-4 h-4" />
                            </button>
                            <button className="px-8 py-4 rounded-xl font-medium text-slate-700 border border-slate-300 hover:bg-slate-100 hover:text-slate-900 transition-all">
                                View Demo
                            </button>
                        </motion.div>
                    </div>
                    ...
                    <div className="relative lg:h-[600px] flex items-center justify-center">
                        <motion.div
                            ...
                            className="relative w-full aspect-video bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden backdrop-blur-xl"
                            style={{ transformStyle: 'preserve-3d', perspective: '1000px' }}
                        >
                            {/* Mock Dashboard UI */}
                            <div className="absolute inset-0 bg-gradient-to-br from-slate-50 to-transparent p-6 flex flex-col gap-4">
                                {/* Top Bar */}
                                <div className="h-8 flex items-center justify-between border-b border-slate-200 pb-4">
                                ...
                                <div className="grid grid-cols-3 gap-4 flex-1">
                                    {/* Main Chart */}
                                    <div className="col-span-2 bg-slate-50 rounded-lg p-4 border border-slate-200 relative overflow-hidden">
                                        ...
                                        <div className="flex items-end gap-2 h-32 mt-4 px-2">
                                            {[40, 60, 45, 70, 50, 80, 65, 90, 75, 100].map((h, i) => (
                                                <motion.div
                                                    ...
                                                    className="flex-1 bg-gradient-to-t from-blue-600 to-cyan-500 rounded-t-sm opacity-80"
                                                />
                                            ))}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-span-1 flex flex-col gap-4">
                                        <div className="flex-1 bg-slate-50 rounded-lg p-4 border border-slate-200">
                                            ...
                                            <div className="w-20 h-6 bg-slate-300 rounded" />
                                        </div>
                                        <div className="flex-1 bg-slate-50 rounded-lg p-4 border border-slate-200">
                        ...
                        <motion.div
                            ...
                            className="absolute -right-8 -bottom-8 bg-white border border-slate-200 p-4 rounded-xl shadow-xl backdrop-blur-md"
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="text-xs text-slate-600">Live Traffic</div>
