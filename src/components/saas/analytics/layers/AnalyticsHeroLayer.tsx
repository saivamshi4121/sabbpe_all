...
export default function AnalyticsHeroLayer() {
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center pt-32 pb-20 overflow-hidden bg-sabbpe-navy-dark">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-900/20 via-sabbpe-navy-dark to-sabbpe-navy-dark" />
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30">
                            ...
                            <span className="text-sm font-medium text-indigo-300">Analytics Engine</span>
                        </div>
                        ...
                        <div className="flex gap-4">
                            <button className="flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white bg-indigo-600 hover:bg-indigo-700 transition-all shadow-lg hover:shadow-indigo-900/20 hover:-translate-y-1">
                                Explore Insights
                    ...
                    <div className="relative">
                        <div className="relative rounded-2xl bg-sabbpe-navy border border-white/10 p-6 shadow-2xl backdrop-blur-xl">
                            {/* Chart Area */}
                            <div className="h-64 flex items-end justify-between gap-2 md:gap-4 px-4 pb-4 border-b border-white/5">
                                {[35, 55, 45, 70, 60, 85, 75, 95].map((h, i) => (
                                    <div key={i} className="w-full h-full flex items-end relative group">
                                        ...
                                        />
                                        {/* Tooltip */}
                                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-white text-black text-xs font-bold px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                                            {h}%
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="flex gap-6 mt-4 justify-center text-sm text-slate-500">
                                ...
                                <span className="flex items-center gap-2">
                                    <span className="w-3 h-3 rounded-full bg-white/10" /> Forecast
                                </span>
                            </div>
                        </div>
                        ...
                        <motion.div
                            ...
                            className="absolute -right-4 -bottom-8 bg-sabbpe-navy-light p-4 rounded-xl border border-white/10 shadow-xl"
                        >
