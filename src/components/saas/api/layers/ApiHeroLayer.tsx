...
export default function ApiHeroLayer() {
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center pt-32 pb-20 overflow-hidden bg-background">
            {/* Background */}
            <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-cyan-100/50 rounded-full blur-[120px] -z-10" />
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-blue-100/50 rounded-full blur-[100px] -z-10" />
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        >
                            ...
                            <span className="text-sm font-medium text-slate-700">API Suite v2.0</span>
                        </motion.div>
                        ...
                        >
                            <button className="flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white bg-blue-600 hover:bg-blue-700 transition-all hover:scale-105">
                                View Documentation
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="absolute -right-6 -top-6 p-4 bg-white rounded-xl border border-slate-200 shadow-xl"
                        >
                        ...
                        <motion.div
                            ...
                            className="absolute -left-6 -bottom-6 p-4 bg-white rounded-xl border border-slate-200 shadow-xl"
                        >
