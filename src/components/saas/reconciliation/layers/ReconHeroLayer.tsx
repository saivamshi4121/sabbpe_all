...
export default function ReconHeroLayer() {
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center pt-32 pb-20 overflow-hidden bg-sabbpe-navy-dark">
            <div className="absolute top-0 right-1/2 w-[800px] h-[800px] bg-emerald-500/10 rounded-full blur-[120px] -z-10" />
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30">
                            ...
                            <span className="text-sm font-medium text-emerald-300">Automated Reformation</span>
                        </div>
                        ...
                        <div className="relative w-full max-w-md">
                            ...
                            >
                                <div className="p-3 rounded-lg bg-white/5 border border-white/10 flex items-center gap-2">
                                    ...
                                    <span className="text-xs text-slate-300">Bank Statement</span>
                                </div>
                                <div className="p-3 rounded-lg bg-white/5 border border-white/10 flex items-center gap-2">
                                    <FileText className="w-4 h-4 text-orange-400" />
                                    <span className="text-xs text-slate-300">Gateway Report</span>
                                </div>
                            </motion.div>

                            {/* Processing Logic */}
                            <div className="mx-auto w-32 h-32 rounded-full border-2 border-emerald-500/30 flex items-center justify-center relative">
                                <motion.div
                                    animate={{ rotate: 360 }}
                            ...
                            >
                                <div className="p-3 rounded-lg bg-emerald-500/20 border border-emerald-500/30 flex items-center gap-2 shadow-[0_0_15px_rgba(16,185,129,0.2)]">
                                    <CheckCircle2 className="w-4 h-4 text-emerald-400" />
                                    <span className="text-xs text-white font-bold">Matched</span>
                                </div>
                                <div className="p-3 rounded-lg bg-emerald-500/20 border border-emerald-500/30 flex items-center gap-2 shadow-[0_0_15px_rgba(16,185,129,0.2)]">
                                    <CheckCircle2 className="w-4 h-4 text-emerald-400" />
                                    <span className="text-xs text-white font-bold">Settled</span>
                                </div>
                            </motion.div>
                            ...
                            <svg className="absolute inset-0 w-full h-full pointer-events-none -z-10 opacity-30">
                                ...
                                <line x1="20%" y1="70%" x2="40%" y2="50%" stroke="white" strokeWidth="1" />
                                <line x1="60%" y1="50%" x2="80%" y2="30%" stroke="#34d399" strokeWidth="1" />
                                <line x1="60%" y1="50%" x2="80%" y2="70%" stroke="#34d399" strokeWidth="1" />
                            </svg>
                        </div>
                    </div>
                </div>
